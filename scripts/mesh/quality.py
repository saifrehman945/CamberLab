...
def write_metadata(
    ...
    payload = {
        ...
        "mesh": {
            ...
            "transition_wake_length":      cfg.get("transition_wake_length"),
            "transition_wake_pts":         cfg.get("transition_wake_pts"),
            "transition_wake_progression": metrics.get("transition_wake_progression"),
            "te_chord_fraction":     cfg.get("te_chord_fraction"),
            "te_blunt_pts":          cfg.get("te_blunt_pts"),
            "te_half_thickness":     metrics.get("te_half_thickness"),
            "te_blunt_progression":  metrics.get("te_blunt_progression"),
            "seam_progression":      metrics.get("seam_progression"),
            "h_te_airfoil_target":   metrics.get("h_te_airfoil_target"),
            "h_trans_first":         metrics.get("h_trans_first"),
            "h_trans_last":          metrics.get("h_trans_last"),
            "h_main_first":          metrics.get("h_main_first"),
